...
const I18N={
  ...
  zh:{
    ...
    policyEyebrow:'预约规则',policyTitle:'预约后不退款',policyText:'No-show、迟到、临时改变主意或自己选错场次均不退款。请至少提前 5 分钟到场。',policyException:'如果场次由学校或主办方取消，我们会联系受影响的参与者并另行安排。',policyEncore:'玩家可提前预约多个 The Final Bell 场次，每个场次按正常票价计算。完成第一轮后，如当天仍有剩余座位，可现场以 RM10 Encore 价参与额外场次。Encore 场次不重复赠送 Mystery Gift。',footerNote:'公平游戏 · 尊重 GM · 玩得开心',
