...
const I18N={
  ...
  zh:{
    ...
    featureRoleTitle:'先认识所有角色',featureRoleText:'所有角色规则在开局前公开，但你实际抽到的角色必须保密。',featurePhoneTitle:'主游戏禁用手机',featureZombieTitle:'太早被淘汰？',featureZombieText:'可以前往 Zombie Dance 区继续参与万圣节活动，不需要坐着等整局结束。',
    ...
    policyEyebrow:'预约规则',policyTitle:'预约后不退款',policyText:'No-show、迟到、临时改变主意或自己选错场次均不退款。请至少提前 5 分钟到场。',policyException:'如果场次由学校或主办方取消，我们会联系受影响的参与者并另行安排。',footerNote:'公平游戏 · 尊重 GM · 玩得开心',
